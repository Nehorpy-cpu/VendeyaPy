# Instrucciones para Codex — Proyecto AI_AFG

> Estas instrucciones aplican a cualquier sesión de Codex que opere en `C:\AI_AFG\` o subdirectorios.
...
- Modificar `C:\Users\Usuario\.Codex\settings.json` (config global Codex — auto-modificación)
...
## Habilitaciones que Codex SÍ puede hacer libremente
