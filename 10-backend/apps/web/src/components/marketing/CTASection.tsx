 ...
 * CTA primario por WhatsApp (sin backend) y secundario al panel.
 */
    ...
    <section id={id} className={cn('mk-container scroll-mt-24', className)}>
      <div className="relative overflow-hidden rounded-3xl bg-ink-deep px-6 py-14 sm:px-12 sm:py-16">
        ...
        <div className="relative mx-auto flex max-w-2xl flex-col items-center text-center">
          <Eyebrow tone="dark">Agendá tu demo</Eyebrow>
          ...
          <p className="mt-4 max-w-xl text-base leading-relaxed text-ink-200 sm:text-lg">
            Te mostramos en 20 minutos cómo conectar catálogo, bot, vendedores y campañas — con tus
            propios números. Sin compromiso.
          </p>
          <div className="mt-8 flex w-full flex-col items-center justify-center gap-3 sm:w-auto sm:flex-row">
            <Button href={whatsappHref} variant="primary" size="lg" target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto">
              <WhatsappIcon className="h-5 w-5" />
              Agendar demo por WhatsApp
            </Button>
            <Button href={panelHref} variant="white" size="lg" className="w-full sm:w-auto">
              Entrar al panel
            </Button>
          </div>
