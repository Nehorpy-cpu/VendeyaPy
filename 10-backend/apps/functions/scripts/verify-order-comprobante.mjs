...
await db.doc(`tenants/${T}/metaAssets/${PNID}`).set({ id: PNID, tenantId: T, connectionId: 'main', assetType: 'whatsapp_phone_number', externalId: PNID, name: 'wa-comp', status: 'active', selected: true, automationMode: 'live', createdAt: now, updatedAt: now });
